...
Use this copy for a public feedback preview. Do not describe CCP as a finished standard.
...
This is a draft for review, not a stable standard yet.
```

## Short Link Text

```text
Draft CCP feedback preview: permissioned pet context for trusted interoperability.
```
