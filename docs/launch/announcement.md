...
- Does the v1 Facility Truth scope set (profile, hours, services, contact methods, service area, acceptance criteria, booking methods, policy summaries) cover your facility-truth needs? Should partner-only scopes (certifications, insurance statements, capacity status, staff credentials) come next?
