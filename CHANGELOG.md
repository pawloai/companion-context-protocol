...
- `THREAT_MODEL.md` §Cross-Profile Inference tightened: converts the open-ended "Future drafts should define stronger guidance" line into a concrete `0.2` agenda item tracked in GitHub issue #7 with forward links to the new compatibility-risks section and worked example.
