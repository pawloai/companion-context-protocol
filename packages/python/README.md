...
The canonical JSON Schemas remain the source of truth. Python implementers should validate request, response, and permission grant objects against `../../schemas/` until generated models are introduced.
