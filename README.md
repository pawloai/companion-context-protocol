...
- Does the v1 Facility Truth scope set cover your facility-truth needs? Are the eight public-fact scopes (profile, hours, services, contact methods, service area, acceptance criteria, booking methods, policy summaries) the right cut for an agent grounding on your facility?
